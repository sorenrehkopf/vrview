...
function FusionPositionSensorVRDevice() {
  ...
  // Temporarily added to solve the iOS cross domain issue.
  window.addEventListener('devicemotion-iframe', this.onDeviceMotionChange_.bind(this));
 ...
 * events work.
 */
var element = document.querySelector('[googleVR]')||window;
