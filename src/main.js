...
window.element = document.querySelectorAll('[googleVR]');
element = element[0]?element:document.body;

if(element.length){
  element = element[0];
  loadGoogleVR(element[0]);
}else{
  loadGoogleVR(element);
}

function loadGoogleVR(element){
